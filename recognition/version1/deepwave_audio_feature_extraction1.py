...
mozila_dataset_path = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15-en.tar.gz'

with tarfile.open(mozila_dataset_path, 'r:gz') as tar:
    tar.extractall(path='/content/drive/MyDrive/dataset/TeamDeepwave/dataset')

import pandas as pd

tsv_file_path1 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/clip_durations.tsv'
tsv_file_path2 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/invalidated.tsv'

tsv_file_path3 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/other.tsv'
tsv_file_path4 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/reported.tsv'

tsv_file_path5 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/unvalidated_sentences.tsv'
tsv_file_path6 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/validated.tsv'

tsv_file_path7 = '/content/drive/MyDrive/dataset/TeamDeepwave/dataset/cv-corpus-17.0-delta-2024-03-15/en/validated_sentences.tsv'
...
dataframes = [pd.read_csv(file_path, sep='\t') for file_path in tsv_file_paths]
df_combined = pd.concat(dataframes)
print(df_combined.head(10))

save_path = '/content/drive/My Drive/path_to_your_directory/combined_data.csv'
df_combined.to_csv(save_path, sep='\t', index=False)
